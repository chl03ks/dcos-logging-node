module.exports = function methods(request) {
    ...
    return {
        ...
        framework: (agentId, frameworkId, executorId, containerId) => {
            /**
             * @param agent_id String
        ...
        frameworkDownload: (agentId, frameworkId, executorId, containerId) => {
            /**
             * @param agent_id String
             * @param framework_id String
             * @param executor_id Stringd
